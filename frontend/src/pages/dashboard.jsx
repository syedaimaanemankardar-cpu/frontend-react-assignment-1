      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl p-6 shadow-lg border-2 border-yellow-200 hover:shadow-xl transform hover:-translate-y-1 transition-all"
            >
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-yellow-200 mb-8">
          ...
          <p className="text-green-700 mb-6">
            Enter ingredients you have and let's create magic!
          </p>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-yellow-200">
            ...
            <div className="space-y-4">
              {recentRecipes.map((recipe) => (
                <div
                  key={recipe.id}
                  className="bg-gradient-to-br from-amber-50 to-green-50 rounded-2xl p-4 border-2 border-yellow-100 hover:border-yellow-300 transition-all"
                >
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <Heart
                        size={20}
                        className={recipe.saved ? "fill-red-600" : ""}
                      />
                    </button>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-yellow-200 mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {suggestedRecipes.map((recipe) => (
              <div
                key={recipe.id}
                className="bg-gradient-to-br from-yellow-50 to-green-50 rounded-2xl p-6 border-2 border-yellow-200 hover:border-yellow-400 hover:shadow-lg transition-all transform hover:-translate-y-1"
              >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-green-100 text-lg">
                "Always let your meat rest for 5-10 minutes after cooking. This
                allows the juices to redistribute, making it more tender and
                flavorful!"
              </p>
            </div>
          </div>
